...
export default function RecentProducts() {
  ...
  if (isLoading) {
    return (
      <div className="text-center py-10 text-lg font-bold">Loading...</div>
    );
  }
   if (isError) {
    return (
      <div className="text-center py-10 text-lg font-bold">Error occurred while fetching recent products.{error.message}</div>
    );
  }
  return (
    <>
